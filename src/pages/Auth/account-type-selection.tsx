...
export const AccountTypeSelection = () => (
  <>
    ...
    <nav className={styles.accountSwitcher}>
      <NavLink className={styles.accountSwitcherLink} to={getUrlWithParams(PageUrls.SignUpPatient)}>
      ...
      <NavLink className={styles.accountSwitcherLink} to={getUrlWithParams(PageUrls.SignUpDoctor)}>
        <div className={styles.accountSwitcherVisual}>
          <img alt="MD" src={iconDoctor} />
        </div>
        <strong className={styles.accountSwitcherTitle}>MD</strong>
      </NavLink>
      <NavLink className={styles.accountSwitcherLink} to={getUrlWithParams(PageUrls.SignUpCaregiver)}>
        <div className={styles.accountSwitcherVisual}>
