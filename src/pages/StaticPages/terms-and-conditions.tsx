    ...
    <ul>
      <li>
        <p>
          ...
          electronic device, named Medical app
        </p>
      </li>
      <li>
        <p>
          <strong>Application Store</strong> means the digital distribution service operated and developed by Apple Inc.
      ...
      <li>
        <p>
          ...
          &quot;Our&quot; in this Agreement) refers to Medical LLC, 303 rue Levy, Montreal, H3C 5K4.
        </p>
      </li>
      <li>
        <p>
