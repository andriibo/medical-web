...
export const PrivacyPolicy = () => (
  <>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Application</strong> refers to Medical app, the software program provided by the Company.
        </p>
      </li>
      <li>
        <p>
    ...
    <p>
      ...
      may be uploaded to the Company&apos;s servers and/or a Service Provider&apos;s server or it may be simply stored
      on Your device.
    </p>
